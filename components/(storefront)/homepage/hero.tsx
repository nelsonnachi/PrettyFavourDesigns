  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#f4e3d0]">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Mobile: readable area on the left, bag stays visible on the right */}
        <div className="absolute inset-0 bg-linear-to-b from-[#f4e3d0]/96 via-18% via-[#f4e3d0]/78 to-[#f4e3d0]/5 lg:hidden" />

        {/* Desktop: wide left-to-right fade */}
        <div className="absolute inset-0 hidden bg-linear-to-r from-[#f4e3d0]/95 via-[#f4e3d0]/40 to-transparent lg:block" />

        {/* Bottom fade */}
        <div className="absolute inset-x-0 bottom-0 h-24 bg-linear-to-t from-[#faf7f1]/35 to-transparent" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-155 max-w-360 items-start px-5 pt-30 pb-16 sm:min-h-162 sm:px-8 sm:pt-24 md:min-h-170 md:pt-28 lg:min-h-162 lg:items-center lg:px-10 lg:py-24">
        <div className="relative z-10 w-full max-w-[340px] sm:max-w-[450px] md:max-w-[500px] lg:max-w-[590px]">
          ...
          <div className="mb-4 flex items-center gap-3 sm:mb-5 lg:mb-5">
            ...
            <p className="text-[12px] font-semibold uppercase tracking-[0.25em] text-[#6d5141] sm:text-[9px] sm:tracking-[0.3em] lg:text-[12px] lg:tracking-[0.32em]">
              Handcrafted Bags
            </p>
          </div>

          <h1 className="max-w-[340px] font-serif text-[60px] font-medium leading-[0.91] tracking-[-0.035em] text-[#211b17] sm:max-w-[470px] sm:text-[56px] md:text-[68px] lg:max-w-[580px] lg:text-[105px] lg:leading-[0.9] lg:tracking-[-0.025em]">
            Timeless Bags
            <br />
            for Every{" "}
          ...
          {/* Description */}
          <p className="mt-5 max-w-[310px] text-[14px] leading-[1.7] text-[#413a36] sm:mt-6 sm:max-w-[420px] sm:text-[12px] sm:leading-6 md:text-[13px] lg:mt-7 lg:max-w-[600px] lg:text-[15px]">
            At SHOPPFD, we create beautifully crafted bags that blend style,
            functionality and tradition. Each piece is thoughtfully designed
