...
export function CartItem({ item }: CartItemProps) {
  ...
  const availableStock = item.variant.availableStock;
  ...
  const mutationError = updateError ?? removeError;
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <div className="mt-3 flex items-center gap-2">
            <span
              ...
              style={{
                backgroundColor: item.variant.color.hexCode ?? "#d6cec4",
              }}
              aria-hidden="true"
            />
          ...
          {mutationError && (
            <p className="mt-3 text-xs text-[#e85d22]">
